  ...
  return (
    <div className="screen">
      ...
      {step === 3 && (
        <>
          ...
          <div className="field">
            ...
            <textarea
              value={p.defaultObservation}
              onChange={(e) => set("defaultObservation", e.target.value)}
      ...
      <div className="btn-row">
        {step > 0 && (
          <button className="btn-secondary" onClick={back} disabled={saving}>
            Voltar
          </button>
        )}
        {step < TOTAL - 1 ? (
